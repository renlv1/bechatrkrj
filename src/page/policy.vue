<template>
  <div class="home">
    <div class="section">
      <div class="main-title entry-title">
        <div class="wrap">Privacy Policy</div>
      </div>
      <div class="wrap">
        <main
        ...
        >
          <article
            class="post-entry post-entry-type-page post-entry-715"
            itemscope="itemscope"
          ...
          >
            <div class="entry-content-wrapper clearfix">
              ...
              <div class="entry-content" itemprop="text">
                <h2>www.be.chat – Privacy Policy</h2>
                <p>This privacy policy has been compiled to better serve those who are concerned with how their ‘Personally Identifiable Information’ (PII) is being used online. PII, as described in UK privacy law and information security, is information that can be used on its own or with other information to identify, contact, or locate a single person, or to identify an individual in context. Please read our privacy policy carefully to get a clear understanding of how we collect, use, protect or otherwise handle your Personally Identifiable Information in accordance with our website.</p>
                ...
                <p>
                  www.cyanstonetech.com
                  <br>Wey House
                  <br>58 Hamm Moor Ln
                  <br>ADDLESTONE, KT15 2SF
                  <br>GB
                  <br>info@neuronlabs.uk&nbsp;
                </p>
                <p>Last Edited on 2019-01-02</p>
              </div>
